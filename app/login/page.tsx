          ...
          <div className="flex flex-col justify-between w-[400px] h-[400px] p-8">
            ...
            <form className='flex flex-col gap-4' onSubmit={formik.handleSubmit}>
              <div className='flex flex-col'>
                ...
                <div className={`flex bg-emerald-100 rounded-md w-full ${formik.errors.email && formik.touched.email ? 'border border-rose-600' : ''}`}>
                  <input
                    className='text-md p-3 bg-transparent focus:outline-none w-full'
                    type="text"
                    placeholder="Email"
              ...
              <div className='flex flex-col'>
                ...
                <div className={`flex bg-emerald-100 rounded-md w-full items-center ${formik.errors.password && formik.touched.password ? 'border border-rose-600' : ''}`}>
                  <input
                    className='text-md p-3 bg-transparent focus:outline-none w-full'
              ...
              <button className='w-full p-3 bg-emerald-600 rounded-md text-white'>Sign In</button>
