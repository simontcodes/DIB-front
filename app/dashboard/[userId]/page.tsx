...
export default function Dashboard(props: PageProps) {
  ...
  const tokenSwitch = (roles: string | undefined, index: number) => {
    switch(roles) {
      ...
      case "Regular Admin":
        return (
          <div key={index} className='flex items-center gap-1 bg-orange-900 w-fit py-1 px-3 rounded-md'>
    ...
    <div className="w-full max-w-[1280px] pt-16">
      ...
      <div className='flex flex-col mt-4 bg-emerald-500 rounded-3xl p-4' id="roles-bar">
        <div className='flex gap-2'>
          {
          userRoles.length == 0 
          ? <span className="bg-emerald-900 w-fit py-1 px-3 rounded-md text-white font-medium mx-auto">Please set your roles in settings</span> 
