      ...
      <div className="flex flex-col h-full w-64 bg-gray-900 rounded-md">
        <div className="px-6 pt-8">
          <div className="flex items-center justify-between">
            ...
            >
              <svg
                className="w-5 h-5 text-white stroke-current stroke-[1.5]"
                viewBox="0 0 24 24"
                fill="none"
              >
                <path
            ...
            <button className="flex items-center justify-center p-0.5 rounded bg-gray-800 focus:outline-none focus:ring-1 focus:ring-gray-500">
              <svg
                className="w-3 h-3 text-gray-300 stroke-current stroke-[2]"
                fill="none"
                viewBox="0 0 24 24"
              >
                <path
        ...
        <div className="px-6 pt-4">
          <div className="relative">
            <div className="absolute inset-y-0 left-0 flex items-center pl-2 pointer-events-none">
              <svg
                className="w-4 h-4 text-gray-500 stroke-current stroke-[1.5]"
                fill="none"
                viewBox="0 0 24 24"
              >
                <path
